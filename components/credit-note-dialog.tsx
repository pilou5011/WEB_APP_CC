...
export function CreditNoteDialog({
  ...
  // Charger le PDF avec pdf.js quand le blob est prêt (pour l'affichage tablette)
  useEffect(() => {
  ...
  // Rendu de la page courante dans un canvas (comme les autres documents)
  useEffect(() => {
